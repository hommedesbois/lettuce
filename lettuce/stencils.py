...
class D2Q9(Stencil):
    ...
    Hxxy = np.array([0, 0, -1.0 / 3.0 , 0, 1.0 / 3.0, 2.0 / 3.0, 2.0 /3.0, -2.0 / 3.0, -2.0 / 3.0])
    Hxyy = np.array([0, -1.0 / 3.0, 0, 1.0 / 3.0, 0, 2.0 / 3.0, -2.0 / 3.0, -2.0 / 3.0, 2.0 / 3.0])
    Hxxyy = np.array([1.0 / 9.0, -2.0 / 9.0, -2.0 / 9.0, -2.0 / 9.0, -2.0 / 9.0, -4.0 / 9.0, -4.0 / 9.0, -4.0 / 9.0, -4.0 / 9.0])
